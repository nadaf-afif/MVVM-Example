...
public class NewsByCategoriesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getBundleInformation(getArguments());
        initObserver();
    }

    private void getBundleInformation(Bundle bundle) {
        if (bundle!=null){
           mViewModel.mNewsTopic = bundle.getString(Constants.TOPIC_NAME);
        }
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && mViewModel != null && !isFragmentLoaded){
    ...
    private void setDataToViewPager(NewsDataModel newsDataModel) {
        ...
        if (mAdapter == null) {
            mAdapter = new NewsHeadlineListAdapter(mNewsArticles, getActivity(), mViewModel, true);
        }
